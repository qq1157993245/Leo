...
import com.example.Food.Order.repository.CartRepository;
import com.example.Food.Order.repository.UserRepository;
import com.example.Food.Order.request.LoginRequest;
import com.example.Food.Order.response.AuthResponse;
import com.example.Food.Order.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> signin(@RequestBody LoginRequest req){
        ...
        AuthResponse authResponse = new AuthResponse();
        authResponse.setJwt(jwt);
        authResponse.setMessage("Log in Successfully");
